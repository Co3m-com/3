...
function moveBlueDotFixed(fixedDeltaTime) {
    previousBlueDotDirection = blueDotDirection;
...
function checkCollision() {
    ...
    if (distance < minDistance) {
        ...
        if (blueDotDirection === 1 && blueDotX + blueDotRadiusPx > redCenterX) {
            blueDotDirection = -1;
        } else if (blueDotDirection === -1 && blueDotX + blueDotRadiusPx < redCenterX) {
            blueDotDirection = 1;
        } else {
            blueDotDirection *= -1;
        }
